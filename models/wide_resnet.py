...
class WideResNet(BaseModel):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        super(WideResNet, self).__init__(last_dim, num_classes)
...
def wide_resnet34_5(num_classes):
    return WideResNet(depth=34, num_classes=num_classes, widen_factor=5, dropRate=0.0)